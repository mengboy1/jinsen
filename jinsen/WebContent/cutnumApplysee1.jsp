...
function alldo()
{
    ...
    {   
        if(mytype=="notshenhe"){
        	...
        	$.ajax({
                url:"cutnumServlet?action=seecutnumApply&type="+mytype,
                data:{
                    "action":mytype,
                    //"workid":mymap,
                },
    	...
    	var param = { 
    	        url: "cutnumServlet?action=writepage&type="+mytype, 
    	       }
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function (cellval, row) {
                    ...
                    var  d = '<a href="cutnumServlet?action=single&applyid=\''+ row.applyid + '\'"><button  id="add" data-id="98" class="btn btn-xs btn-primary">查看</button></a>';
...
<!-- <main class="all">
    ...
    <div class="find-top">
        <select style="width: 130px" id="mytype">
            <option value="">---请选择---</option>
            <option value="all" onclick="table1()">全部申请</option>
    ...
    <div class="find-top1" style="margin-top:20px;">
      <table style="border:0px">
		   <tr><td colspan="4" style="text-align: center">
		   <button type="button" data-toggle="modal" data-target="#myModal_all">全部申请</button>
		   <button type="button" data-toggle="modal" data-target="#myModal_not">未审核</button>
		   <button type="button" data-toggle="modal" data-target="#myModal_salary_tree">未通过</button> 
		   <button type="button" data-toggle="modal" data-target="#myModal_produce">已通过</button>
		   </td></tr>
      </table>
    </div>
    <div class="modal fade" id="myModal_all" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="true">
							...
							<form class="form-horizontal" role="form">
								<div class="form-group">
									<div class="col-sm-offset-2 col-sm-10">
										<button type="button" class="btn btn-default" onclick="table1()">确认</button>
									</div>
								</div>
							</form>
						</div>
