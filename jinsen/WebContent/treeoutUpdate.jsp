                ...
                <div class="top">
                   <p class="table_p"><span>树材信息录入</span></p>
                       ...
                       <tr>
                          ...
                          <td><input type="text" name="sale_contract_id" id="sale_contract_id" value="<%=c.getContractnum() %>>"></td>
                          ...
                          <td><input type="text" name="sale_callout_orderid" id="sale_callout_orderid" value="<%=c.getSaleCalloutorderid()%>" placeholder="销售调令"></td>
                         </tr>
                         <tr style="font-size:20px">
                             <td>销售货场<span></span></td>
                             <td><input type="text" name="yard" id="yyard" value="<%=c.getYard() %>" placeholder="货场"></td>
                             <td>货场分区<span></span></td>
                             <td><input value="<%=c.getSection()%>"><select name="section" id="ssection"><option>A区</option><option>B区</option><option>C区</option><option>D区</option><option>无固定位置</option></select></td>
                             <td>检尺标准<span></span></td>
                             <td><input value="<%=c.getBatchNum()%>"><select id="bbratchum" name="batchnum"><option>1-国标</option><option>2-双足码</option><option>3-实码</option></select></td>
                          </tr>
                          <tr>
                            ...
                            <table class="table" >
                                ...
                                <tr >
                                    ...
                                    <td style="font-size:20px">合计树材<span></span>
                                        <input type="text" style="width:120px; font-size:20px" name="tolstere" id="tolstere" value="<%=c.getTolstere()%>">
