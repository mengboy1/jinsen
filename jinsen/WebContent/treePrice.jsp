...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> 仪表盘</a>
  <ul>
    <li class="active"> <a href="treePrice.jsp"><i class="icon icon-th-list"></i> <span>木材销售检尺费</span></a></li>
    <li> <a href="widgets.html"><i class="icon icon-inbox"></i> <span>结算其他费用</span></a> </li>
  </ul>
</div>
<!--sidebar-menu-->
<div id="content">
...
<main>
    ...
    <div class="find-top">
        <p class="p-tail"><i class="i-tail"></i>该界面是生成木材销售检尺费的主要界面</p>
    </div>
