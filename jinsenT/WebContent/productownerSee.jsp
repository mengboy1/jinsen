...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> 仪表盘</a>
  <ul>
    <li><a href="productowner.jsp"><i class="icon icon-home"></i> <span>生产业主平台</span></a> </li>
    <li class="active"><a href="productownerSee.jsp"><i class="icon icon-home"></i><span>查看生产业主信息</span></a> </li>
  </ul>
</div>
<!--sidebar-menu-->
