...
<div class="find-top1">
    <table class="top-table">
     <tr><td class="top-table-label">采伐证号</td><td><input id="cutnum" name="cutnum"></tr>
     <tr><td colspan="10" style="text-align: center"><button class="add-but" onclick="printCutnum()"><i class="glyphicon glyphicon-edit"></i>砍伐证材料</button></td></tr>
      </table>
  </div>
 <div class="table-con">
